...
<body>
<div class="x-body">
  <form action="/pdms/tenant/addTenantUser" class="layui-form layui-form-pane" style="margin-left: 20px;">
<#--    隐藏域：tenantid = tanantid；-->
  ...
  position: fixed;bottom: 1px;margin-left:-20px;">
    <div class="layui-form-item" style=" float: right;margin-right: 30px;margin-top: 8px">
      ...
      <button  class="layui-btn layui-btn-normal" lay-filter="add" lay-submit type="submit">
        邀请
      </button>
